...
import SagarFullPose from "/public/images/Salman-Full-pose.png";
      ...
      <div className="flex w-full flex-col justify-between gap-12 md:flex-row">
        ...
        <div className="flex max-w-xl flex-col gap-6">
          ...
          <Typography>
            ...
            challenges and learning the new technologies along the way. Now, in
            my early twenties, 2 years after starting my web development
            journey, I&apos;m building cutting-edge web applications using
            modern technologies such as Node.js, MongoDB, Express.js,React.js
            Tailwindcss,BootStrap and much more.
          </Typography>
          <Typography>
